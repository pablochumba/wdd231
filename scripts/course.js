...
function displayCourses(courseArray) {
    ...
    const totalCredits = courseArray.reduce(function (total, course) {
...
filterButtons.forEach(function (button) {
    button.addEventListener("click", function () {
        ...
        if (category === "all") {
            filteredCourses = courses; // no filtering needed, show everything
        } else {
            filteredCourses = courses.filter(function (course) {
                return course.subject.toLowerCase() === category;
            });
        }
